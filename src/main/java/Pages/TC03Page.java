...
public class TC03Page {
    ...
    public By requiredMsgLocator=By.className("oxd-input-group__message");


    public TC03Page(WebDriver driver, WebDriverWait wait) {
    ...
    @Step("enter empty login credentials ")
    ...
    public List<WebElement> getMsgElement() {
        return driver.findElements(requiredMsgLocator);
    }
}
